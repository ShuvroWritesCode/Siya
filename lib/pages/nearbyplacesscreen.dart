...
class _NearByPlacesScreenState extends State<NearByPlacesScreen> {
  ...
  String apiKey = "AIzaSyCogmtZENyaIKKeydEoZIfcX1ulyVRv-QE";
  String radius = "30";
  ...
  void getNearbyPlaces() async {
    ...
    var url = Uri.parse('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=33.68060824514047,73.0151709698594&radius=1500&type=restaurant,hospital&key=AIzaSyCogmtZENyaIKKeydEoZIfcX1ulyVRv-QE');
