...
class _AddReminderPageState extends State<AddReminderPage> {
  late AddReminderBloc _newEntryBloc;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: const Text('Add New')),
      ),
      body: Provider<AddReminderBloc>.value(
        value: _newEntryBloc,
        child: ListView(
          children: [
            // Container(
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval!).floor(); i++) {
      ...
      var dateTime = DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day, hour,minute,0);
      // print(dateTime);
  ...
  //     print(int.parse(medicine.notificationIDs![i]));
...
class _SelectTimeState extends State<SelectTime> {
  ...
  Future<TimeOfDay> _selectTime() async {
    ...
    final AddReminderBloc newEntryBloc =
    Provider.of<AddReminderBloc>(context, listen: false);
          ...
          child: Center(
            child: Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .bodyMedium!
                  .copyWith(color: kGreenSecondaryColor),
            ),
          ),
        ),
      ),
